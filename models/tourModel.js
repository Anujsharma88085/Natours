...
const tourSchema = new mongoose.Schema(
  {
    ...
    difficulty: {
      type: String,
      required: [true, 'A tour should must have a difficulty'],
      enum: {
    ...
    startLocation: {
      // GeoJSON for geographical coordinates
      type: {
        type: String,
        default: 'Point',
...
//This code is responsible for embedding user document in tour document
...
tourSchema.post(/^find/, (docs, next) => {
  ...
  // if you don't use this then prefer arrow-callback function
  // console.log(docs);
  next();
});
